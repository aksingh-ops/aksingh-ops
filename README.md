...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0A3161&height=180&section=header&text=Akash%20Singh&fontSize=52&fontColor=ffffff&fontAlignY=38&desc=Data%20Analyst%20%7C%20Business%20Analyst%20%7C%20BI%20Engineer&descAlignY=60&descColor=B8D4F0&animation=fadeIn" />
...
With **3+ years of experience** across government analytics, BI engineering, and enterprise data platforms, I work across the full analytics lifecycle &mdash; from writing SQL pipelines and building ML models to drafting business requirements documents, defining KPIs, and delivering plain-English recommendations to non-technical leadership.
...
**Certifications:** Alteryx Designer Core (85.6%) &bull; Bloomberg Market Concepts (Feb 2026) &bull; Microsoft Power BI Data Analyst (Coursera) &bull; Preparing Data for Analysis with Microsoft Excel

---

## Industry Coverage

Projects span nine industries &mdash; meaning I can contribute on day one regardless of your sector:
...
![Financial Services](https://img.shields.io/badge/Financial_Services_%26_Credit-6C3483?style=for-the-badge)
...
<table>
  ...
  <tr>
    ...
    <td>DuckDB SQL &bull; Python &bull; CMS Part D Data</td>
    <td>$562.4M quality bonus revenue at risk identified across 3 triple-weighted CMS Star Rating measures &bull; 46/51 states below diabetes threshold &bull; 1.51M beneficiaries &bull; BRD + 4 SQL files + revenue model + specialty ranking + exec recommendation</td>
  </tr>
  ...
  <tr>
    ...
    <td>Python &bull; DuckDB SQL &bull; scipy &bull; statsmodels</td>
    <td>50K users &bull; No significant reorder lift (p=0.52) &bull; Guardrail breached: $7.42 net revenue loss per user &bull; $9.05M annual loss at 100K users/month &bull; Experiment design doc + power analysis + 3 hypothesis tests + dollar model + Go/No-Go recommendation</td>
  </tr>
  ...
  <tr>
    ...
    <td>Python &bull; XGBoost &bull; BTS Data &bull; SHAP</td>
    <td>AUC 0.87 &bull; Recall 0.91 on 820,876 BTS flight records &bull; $1.3M estimated annual reserve savings at DFW and CLT &bull; Original Schedule Stress Score feature ranked #4 of 35 by SHAP importance</td>
  </tr>
  ...
  <tr>
    ...
    <td>Excel &bull; Power Query &bull; LAMBDA</td>
    <td>Six-sheet audit pipeline for 1,040 SKUs &bull; Automated validation for 7 issue types &bull; Weighted seller quality scorecard &bull; Grounded in Best Buy Marketplace Standard Terms (April 2025)</td>
  </tr>
  ...
  <tr>
    ...
    <td>Excel &bull; SQL-style Analysis &bull; FRED Data</td>
    <td>120 SKUs stress-tested across 4 tariff scenarios (0% to 200%) &bull; Break-even reprice and reorder urgency surfaced per SKU &bull; Anchored to FRED electronics inventory-to-sales ratio</td>
  </tr>
  ...
  <tr>
    ...
    <td>Python &bull; Alteryx ETL &bull; OLS &bull; Statsmodels</td>
    <td>R-squared 0.9325 &bull; Controlled gender gap 2.52% (p=0.0005) &bull; Detected 4 of 5 injected pay gaps including a Finance VP cohort of only 15 employees (p=0.0095)</td>
  </tr>
  ...
  <tr>
    ...
    <td>HR & People Analytics</td>
    <td>Python &bull; Random Forest &bull; SHAP &bull; SMOTE</td>
    <td>AUC 0.748 on 1,470 IBM HR records &bull; High-risk tier validated at 41.7% actual attrition vs 8.1% Low-risk &bull; SHAP TreeExplainer surfaced top drivers per employee</td>
  </tr>
  ...
  <tr>
    ...
    <td>Python &bull; Z-score &bull; CUSUM &bull; SARIMAX</td>
    <td>100% detection (8/8) of injected failure events &bull; 29% false alarm reduction &bull; SARIMAX MAPE 0.12% on 140,544 metric readings across 4-layer GBM financial platform</td>
  </tr>
  ...
  <tr>
    ...
    <td>Python &bull; SQL &bull; Power BI</td>
    <td>End-to-end credit portfolio surveillance &bull; Early warning system tracking delinquency trends, concentration risk, and portfolio migration &bull; Executive Power BI dashboard with segment breakdowns</td>
  </tr>
  ...
  <tr>
    ...
    <td>Python &bull; scikit-learn &bull; XGBoost &bull; Prophet &bull; statsmodels</td>
    <td>5-model regression (XGBoost RMSE 0.85) &bull; 5-model classification (Gradient Boosting accuracy 0.39) &bull; 3 clustering techniques &bull; Exponential Smoothing RMSE 16.98 on AirPassengers forecasting</td>
  </tr>
  ...
  <tr>
    ...
    <td>Python &bull; NetworkX &bull; TextBlob &bull; NLTK &bull; SVD &bull; yfinance</td>
    <td>PageRank + HITS on 289K-edge social graph &bull; Institutional holders bipartite network for 20 tickers &bull; Dual sentiment ranking (TextBlob + VADER) &bull; SVD collaborative filtering RMSE 1.04 on 75.5% sparse utility matrix</td>
  </tr>
...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0A3161&height=100&section=footer&fontColor=ffffff" />
